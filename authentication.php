...
$registerRepeatPassword = (isset($_POST['registerRepeatPassword'])) ? $_POST['registerRepeatPassword']:" ";
...
if (!empty($_POST['registerPassword']) & !empty($_POST['registerRepeatPassword']) & !empty($_POST['registerEmail'])) {
    if (($_POST['registerPassword']) === ($_POST['registerRepeatPassword'])) {
        $passwordErr =  $mensaje['registerSuccessfull'];
    } else {
        $passwordErr = $mensaje['contraseñasNoCoinciden'];
    }
} else {
    $passwordErr = " ";
}
...
if (isset($_POST['loginEmail'])) {
    ...
    foreach ($usuario as $email => $contraseña) {
        if ($email == $loginEmail & $contraseña == $loginPassword) {

            $passwordErr = $mensaje['loginSuccessfull'];
        }else { 
       

            $passwordErr = $mensaje['loginError'];
    }
