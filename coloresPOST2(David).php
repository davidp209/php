<?php
if(empty($_POST['ans'])){
    if(array_key_exists('cookieImagen', $_COOKIE)){
        $imagen = $_COOKIE['cookieImagen'];
    }else {
        $imagen = "https://miro.medium.com/max/4800/1*r2fR_OBcBCSUtfLLaTX3JA.png";
      }
}else{
    $imagen = htmlspecialchars( $_POST['ans']);//lo de htmlspecialchars es por si hay algun caracter raro en la url no de fallo
    setcookie('cookieImagen', $imagen,time()+(86400 * 30));//86400 --> segundos en 1dia
}
...
<div id="wrapper">
    ...
    <section id="main">
        <header>
            <span class="avatar"><img src=<?php echo $imagen  ?> alt="" width="256px"/></span>
            ...
            <form name="calculator" action="" method="post">
                ...
                <input type="textfield" name="ans" value=""  style="background-color:rgb(255, 255, 255)">
                <br>
