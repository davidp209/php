...
<div id="wrapper">
    ...
    <section id="main" style="width: 50em">
        <header>
            ...
            <h2>Ahorcado</h2>
            <form name="ahorcado" action="" method="post">
                <!-- Escribe el resultado como valor de la propiedad value -->
                <input type="textfield" name="aciertos" value=""  style="background-color:white">
                <input type="hidden" name="incognita" value=""  style="background-color:white">
                <input type="hidden" name="letrasUsadas" value="">
                <select name="letraActual">
                    <?php for($letra = ord('A'); $letra <= ord('Z'); $letra++) : ?>
                        <option value="<?php echo chr($letra) ?>"><?php echo chr($letra) ?></option>
                    <?php endfor; ?>
                </select>
                <br>
